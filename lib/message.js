...
<div class="toast-container">\
  <div class="toast-content">\
    ...
    <a class="toast-close" href="#" title="dismiss" aria-label="close notification">\
...
module.exports = {
  ...
  show: function() {
    ...
    el.querySelector('.toast-message').innerHTML = this.message
    ...
    Event.one(this.el, 'click', '.toast-close', this.remove.bind(this))
